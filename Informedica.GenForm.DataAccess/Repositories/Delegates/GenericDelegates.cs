...
{
    public class GenericDelegates: RepositoryDelegates<IGeneric, Substance>
    {
        #region Singleton

        private GenericDelegates() { }

        private static GenericDelegates Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (LockThis)
                    {
                        if (_instance == null) _instance = new GenericDelegates();
                    }
                }
                return (GenericDelegates)_instance;
            }
        }
        ...
        #region Overrides of RepositoryDelegates<IGeneric,Substance>
