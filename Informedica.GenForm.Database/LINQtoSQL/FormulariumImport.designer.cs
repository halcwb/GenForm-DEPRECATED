...
namespace Informedica.GenForm.Database.ORM.LINQtoSQL
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="FormulariumArthur")]
    ...
    partial void DeleteDoseringsadviesToepassingsgroep(DoseringsadviesToepassingsgroep instance);
		...
		public FormulariumImportDataContext() : 
				base(global::Informedica.GenForm.Database.ORM.Properties.Settings.Default.FormulariumArthurConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	[Table(Name="dbo.Doseringsadvies")]
    ...
    partial void OnadviestekstChanged();
		...
		[Column(Storage="_doseringsadviesId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_adviestekst", DbType="NVarChar(MAX)")]
		...
		[Association(Name="Doseringsadvies_PreparaatDoseringsadvies", Storage="_PreparaatDoseringsadvies", ThisKey="doseringsadviesId", OtherKey="doseringsadviesId")]
		...
		[Association(Name="Doseringsadvies_DoseringsadviesToedieningswijze", Storage="_DoseringsadviesToedieningswijze", ThisKey="doseringsadviesId", OtherKey="doseringsadviesId")]
		...
		[Association(Name="Doseringsadvies_DoseringsadviesToepassingsgroep", Storage="_DoseringsadviesToepassingsgroep", ThisKey="doseringsadviesId", OtherKey="doseringsadviesId")]
	...
	[Table(Name="dbo.PreparaatDoseringsadvies")]
    ...
    partial void OnpreparaatName_IDChanged();
		...
		[Column(Storage="_preparaatName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_doseringsadviesId", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int doseringsadviesId
		{
			get
			{
		...
		[Column(Storage="_preparaatName_ID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Doseringsadvies_PreparaatDoseringsadvies", Storage="_Doseringsadvies", ThisKey="doseringsadviesId", OtherKey="doseringsadviesId", IsForeignKey=true)]
		...
		[Association(Name="Preparaat_PreparaatDoseringsadvies", Storage="_Preparaat", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID", IsForeignKey=true)]
    ...
    partial void OnstofName_IDChanged();
		...
		[Column(Storage="_stofName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_stofName_ID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Preparaat_PreparaatStof", Storage="_Preparaat", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID", IsForeignKey=true)]
		public Preparaat Preparaat
		{
			get
			{
	...
	[Table(Name="dbo.PreparaatToepassingsgroep")]
    ...
    partial void OntoepassingsgroepName_IDChanged();
		...
		[Column(Storage="_toepassingsgroepName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_toepassingsgroepName_ID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Preparaat_PreparaatToepassingsgroep", Storage="_Preparaat", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID", IsForeignKey=true)]
		public Preparaat Preparaat
		{
			get
			{
	...
	[Table(Name="dbo.PreparaatToediening")]
    ...
    partial void Ontoedieningswijze_IDChanged();
		...
		[Column(Storage="_toedieningswijze", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_toedieningswijze_ID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Preparaat_PreparaatToediening", Storage="_Preparaat", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID", IsForeignKey=true)]
		public Preparaat Preparaat
		{
			get
			{
    ...
    partial void OnpreparaatName_IDChanged();
		...
		[Column(Storage="_prijs", DbType="Decimal(19,4)")]
		...
		[Column(Storage="_aflevervorm", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_merk", DbType="NVarChar(MAX)")]
		public string merk
		{
			get
			{
		...
		[Column(Storage="_toedieningsvorm", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_gebruiksnaam", DbType="NVarChar(MAX)")]
		...
		[Association(Name="Preparaat_PreparaatDoseringsadvies", Storage="_PreparaatDoseringsadvies", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID")]
		public EntitySet<PreparaatDoseringsadvies> PreparaatDoseringsadvies
		{
			get
			{
		...
		[Association(Name="Preparaat_PreparaatStof", Storage="_PreparaatStof", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID")]
		...
		[Association(Name="Preparaat_PreparaatToepassingsgroep", Storage="_PreparaatToepassingsgroep", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID")]
		...
		[Association(Name="Preparaat_PreparaatToediening", Storage="_PreparaatToediening", ThisKey="preparaatName_ID", OtherKey="preparaatName_ID")]
	...
	[Table(Name="dbo.DoseringsadviesToedieningswijze")]
    ...
    partial void Ontoedieningswijze_IDChanged();
		...
		[Association(Name="Doseringsadvies_DoseringsadviesToedieningswijze", Storage="_Doseringsadvies", ThisKey="doseringsadviesId", OtherKey="doseringsadviesId", IsForeignKey=true)]
		public Doseringsadvies Doseringsadvies
		{
			get
			{
	...
	[Table(Name="dbo.DoseringsadviesToepassingsgroep")]
    ...
    partial void OntoepassingsgroepName_IDChanged();
		...
		[Association(Name="Doseringsadvies_DoseringsadviesToepassingsgroep", Storage="_Doseringsadvies", ThisKey="doseringsadviesId", OtherKey="doseringsadviesId", IsForeignKey=true)]
		public Doseringsadvies Doseringsadvies
		{
			get
			{
